...
if __name__ == "__main__":
    ...
    data = tfidf_vectorizer.fit_transform(
        data_frame[DATA_KEY]
    )

    joblib.dump(tfidf_vectorizer, TF_IDF_VECTORIZER_NAME)
    ...
    for train_index, test_index in kFolder.split(data):
        ...
        for key, algorithm in algorithms.items():
            algorithm["train"](data_train, target_train, fold_count)
